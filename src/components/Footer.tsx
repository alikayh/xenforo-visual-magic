      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center md:text-right flex flex-col items-center md:items-start">
            ...
            <p className="text-gray-600 mb-4 text-sm">
              انجمن نویسندگان رانشا، مکانی برای رشد و پیشرفت نویسندگان
            </p>
                ...
                <ul className="space-y-3">
                  {categoryLinks.map((link) => (
                    <li key={link.name}>
                      <Link 
                        to={link.href} 
                        className="text-gray-600 hover:text-primary transition-colors duration-200 underline-animate"
                      >
                        {link.name}
                      </Link>
                    </li>
        ...
        <div className="border-t border-gray-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            طراحی شده توسط تیم رانشا - {currentYear} &copy;
          </p>
