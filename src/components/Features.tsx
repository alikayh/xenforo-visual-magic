        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              چرا به انجمن <span className="text-primary">رانشا</span> بپیوندید؟
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              انجمن رانشا مجموعه‌ای از امکانات و خدمات را برای نویسندگان فراهم کرده است تا بتوانند در مسیر نویسندگی حرفه‌ای رشد کنند.
            </p>
          </div>
