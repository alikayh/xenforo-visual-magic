      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto text-center">
          <div className="mb-6 opacity-0 animate-fade-in">
            <Badge variant="primary" className="mb-4">انجمن نویسندگان راشای</Badge>
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-3xl mx-auto text-balance">
              محلی برای آموزش، اشتراک‌گذاری و توسعه مهارت‌های نویسندگی. در انجمن راشای با نویسندگان دیگر آشنا شوید، رمان‌های خود را به اشتراک بگذارید و از راهنمایی‌های تخصصی بهره‌مند شوید.
            </p>
          ...
          <div className="relative mt-16 opacity-0 animate-fade-in" style={{ animationDelay: '300ms' }}>
            ...
            <div className="relative bg-white/90 backdrop-blur-sm border border-white/20 rounded-2xl shadow-2xl overflow-hidden">
              <div className="p-6 md:p-8 text-center">
                <p className="text-lg font-medium text-primary mb-4">تازیگی ها در انجمن راشای</p>
