        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                دسته‌بندی‌های محبوب انجمن راشای که بیشترین تعداد داستان را در خود جای داده‌اند.
              </p>
            </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="relative rounded-2xl overflow-hidden">
              ...
              <div className="relative z-10 p-12 md:p-16 text-center text-white">
                <h2 className="text-3xl md:text-4xl font-bold mb-6">
                  به جامعه نویسندگان راشای بپیوندید
                </h2>
                <p className="text-lg md:text-xl opacity-90 mb-8 max-w-3xl mx-auto">
                  با عضویت در انجمن راشای، می‌توانید به خانواده بزرگ نویسندگان ایرانی بپیوندید و تجربیات خود را به اشتراک بگذارید.
                </p>
